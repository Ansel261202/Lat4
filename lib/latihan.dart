...
class MemberListPage extends StatelessWidget {
  final List<Member> members = [
    Member(
        name: 'Daniel Alexander Papilaya',
        nim: '32210009',
        birthDate: '25-08-2003'),
    Member(
        name: 'Nathaniel Edgar Santosa',
        nim: '32210086',
        birthDate: '13-05-2003'),
    Member(
        name: 'Glen Anseligo Sihite', nim: '32210087', birthDate: '26-12-2002')
          ...
          return ListTile(
            ...
            onTap: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) =>
                      MemberDetailPage(member: members[index]),
                ),
              );
            },
          );
